			...
			<br>
                ...
                <div class="form-container">
                    <div class="media-container-column" data-form-type="formoid">
                        <!---Formbuilder Form--->
                        <form action="addingactivity.php" method="POST" class="mbr-form form-with-styler" data-form-title="Mobirise Form"><input type="hidden" name="email" data-form-email="true" value="gJx9mYTDCqc5wiV+1ThQbFtpaaAAD8BSYL1293Dr7SnEfZIxWy/1rGw82f99s7sB1D1O/ar9yeMjr0yOMiW4aN394acAJBb95cJFIxzbtANNqbPKSYgvqP+6H1HnxeGX">
                            <div class="row">
                            ...
                            <div class="dragArea row">
                                <div class="col-md-12 form-group " data-for="name">
                                    <input type="text" name="activity" placeholder="activity (250 characters max)" data-form-field="Name" required="required" class="form-control px-3 display-7" id="name-header15-q">
                                </div>
                                <div data-for="phone" class="col-md-12 form-group ">
                                    <input type="text" name="year" placeholder="year" data-form-field="Phone" required="required" class="form-control px-3 display-7" id="phone-header15-q">
                                </div>                           
								
                                <div class="col-md-12 input-group-btn"><button type="submit" class="btn btn-form btn-primary-outline display-4">Add Activity</button></div>
