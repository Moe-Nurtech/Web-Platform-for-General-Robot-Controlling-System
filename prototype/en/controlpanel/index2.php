...
<section class="engine"><a href="https://mobirise.info/z">best css templates</a></section><section class="counters1 counters cid-rWnnxwELsI" id="counters1-g">
    ...
    <div class="container">
        <h2 class="mbr-section-title pb-3 align-center mbr-fonts-style display-2">Navigation Methods</h2>
        <h3 class="mbr-section-subtitle mbr-fonts-style display-5">
            <b><font color="#e83235">UAEU Husky</font> (ROS Indigo Version)</b></h3>
                ...
                <div class="card p-3 align-center col-12 col-md-6 col-lg-3">
                    <div class="panel-item p-3">
                        ...
                        <div class="card-text">
                            ...
                            <h4 class="mbr-content-title mbr-bold mbr-fonts-style display-7">02 Gmapping SLAM (Old)</h4>
                ...
                <div class="card p-3 align-center col-12 col-md-6 col-lg-3">
                    <div class="panel-item p-3">
                        ...
                        <div class="card-text">
                            ...
                            <h4 class="mbr-content-title mbr-bold mbr-fonts-style display-7">Keyboard Navigation</h4>
