...
<section class="engine"><a href="https://mobirise.info/w">html5 templates</a></section><section class="section-table cid-rWopdr2RAg" id="table1-l">
  ...
  <div class="container container-table">
      ...
      <div align = "center">
	  <button onclick="window.location.href= 'addproject.php'" class="btn btn-primary" id="confirm-purchase">Add a project</b></button>
	  </div>
          ...
          <table class="table isSearch" cellspacing="0">
            <thead>
              ...
              <th class="head-item mbr-fonts-style display-7">
                      PROJECT TITLE</th><th class="head-item mbr-fonts-style display-7">
                      PROJECT LINK</th><th class="head-item mbr-fonts-style display-7">
                      DELETE</th></tr>
            </thead>
...
if (mysqli_num_rows($result) > 0) {
    ...
    while($row = mysqli_fetch_assoc($result)) {
		...
		?>
			...
			<input type="hidden" name="deleteproject" value="<?php echo $row["projectname"]; ?>">
