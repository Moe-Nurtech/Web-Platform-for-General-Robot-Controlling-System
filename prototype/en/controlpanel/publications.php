...
<section class="engine"><a href="https://mobirise.info/w">html5 templates</a></section><section class="section-table cid-rWopdr2RAg" id="table1-l">
  ...
  <div class="container container-table">
      ...
      <div align = "center">
	  <button onclick="window.location.href= 'addpublication.php'" class="btn btn-primary" id="confirm-purchase">Add a publication</b></button>
	  	  <button onclick="window.location.href= 'addactivity.php'" class="btn btn-secondary" id="confirm-purchase">Add an Activity</b></button>
	  </div>
          ...
          <table class="table isSearch" cellspacing="0">
            <thead>
              ...
              <th class="head-item mbr-fonts-style display-7">
                      PUBLICATION TITLE</th><th class="head-item mbr-fonts-style display-7">
                      TYPE</th><th class="head-item mbr-fonts-style display-7">
                      DELETE</th></tr>
            </thead>
...
if (mysqli_num_rows($result) > 0) {
    ...
    while($row = mysqli_fetch_assoc($result)) {
		...
		echo "</td><td class='body-item mbr-fonts-style display-7'>"; echo $row['type']." ".$row['year'];
		 ?>
		...
		?>
			<form action="deletepublication.php" method="get">
			<input type="hidden" name="deletepublication" value="<?php echo $row["id"]; ?>">
...
if (mysqli_num_rows($result2) > 0) {
    ...
    while($row2 = mysqli_fetch_assoc($result2)) {
		echo "<tr><td class='body-item mbr-fonts-style display-7'>"; echo $row2['activity'];
		echo "</td><td class='body-item mbr-fonts-style display-7'>"; echo $row2['type']." ".$row2['year'];
		 ?>
		...
		?>
			...
			<input type="hidden" name="deleteactivity" value="<?php echo $row2["id"]; ?>">
			<input type="submit" value="Delete">
			</form>
		<?php
		echo "</td>";
