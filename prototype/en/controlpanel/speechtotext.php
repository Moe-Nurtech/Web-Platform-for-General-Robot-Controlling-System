...
<section class="engine"><a href="https://mobirise.info/z">best css templates</a></section><section class="counters1 counters cid-rWnnxwELsI" id="counters1-g">
    ...
    <div class="container">
        <h2 class="mbr-section-title pb-3 align-center mbr-fonts-style display-2">Speech to Text TEST Run</h2>
        <h3 class="mbr-section-subtitle mbr-fonts-style display-5">
            <b><font color="green"><?php if(isset($_POST['msg'])) {
	echo $_POST['msg']; } ?>
</font></b>
        </h3>
                ...
                <div class="card p-3 align-center col-12 col-md-6 col-lg-3">
                    <div class="panel-item p-3">
                        ...
                        <div class="card-text">
                            ...
                            <h4 class="mbr-content-title mbr-bold mbr-fonts-style display-7">Speech to Text Test Run</h4>
                ...
                <div class="card p-3 align-center col-12 col-md-6 col-lg-3">
                    <div class="panel-item p-3">
                        ...
                        <div class="card-text">
                            ...
                            <h4 class="mbr-content-title mbr-bold mbr-fonts-style display-7">Run Speech to Text</h4>
                            <div class="mbr-section-btn text-center"><a class="btn btn-sm btn-primary-outline display-4" href="loadingspeechtotext.php">Start</a></div>
                        </div>
