...
<section class="engine"><a href="https://mobirise.info/w">html5 templates</a></section><section class="section-table cid-rWopdr2RAg" id="table1-l">
  ...
  <div class="container container-table">
      <h2 class="mbr-section-title mbr-fonts-style align-center pb-3 display-2">Students</h2>
          ...
          <table class="table isSearch" cellspacing="0">
            <thead>
              ...
              <th class="head-item mbr-fonts-style display-7">
                      STUDENT NUMBER</th><th class="head-item mbr-fonts-style display-7">
                      SHARED HOSTING</th><th class="head-item mbr-fonts-style display-7">
                      DELETE</th></tr>
            </thead>
...
if (mysqli_num_rows($result) > 0) {
    ...
    while($row = mysqli_fetch_assoc($result)) {
		echo "<tr><td class='body-item mbr-fonts-style display-7'>"; echo $row['studentnumber'];
		echo "</td><td class='body-item mbr-fonts-style display-7'>"; ?>
		
		<?php
		$mylink = "http://www.nur-tech.net/".$row['studentnumber'];
		echo "<a target='_blank' href='$mylink'>Link</a>";?>
		<?php
		echo "</td><td class='body-item mbr-fonts-style display-7'>";
		?>
			<form action="deletestudent.php" method="get">
			<input type="hidden" name="deleteuser" value="<?php echo $row["studentnumber"]; ?>">
