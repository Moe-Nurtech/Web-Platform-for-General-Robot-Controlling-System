...
<section class="engine"><a href="https://mobirise.info/z">best css templates</a></section><section class="counters1 counters cid-rWnnxwELsI" id="counters1-g">
    ...
    <div class="container">
        <h2 class="mbr-section-title pb-3 align-center mbr-fonts-style display-2">Text Chat Bot</h2>
                ...
                <div class="card p-3 align-center col-12 col-md-6 col-lg-3">
                    <div class="panel-item p-3">
                        ...
                        <div class="card-text">
                            ...
                            <h4 class="mbr-content-title mbr-bold mbr-fonts-style display-7">Text Chat Bot Run</h4>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-8 col-md-offset-2 text-xs-center">
                ...
                <h3><br><font color="#e83235">Please</font> Enter Arabic Text</h3>
                <form action="loadingchdbsp.php" method="post" id="text">
				<br>				
                <input type="text" class="form-control" id="text" name="text" required>
				<br>
              
				<button type="submit" id="confirm-purchase">Send to Abu Saif Database</button>
				</form>
