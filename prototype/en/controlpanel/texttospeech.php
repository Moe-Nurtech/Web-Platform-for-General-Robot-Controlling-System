...
<section class="engine"><a href="https://mobirise.info/z">best css templates</a></section><section class="counters1 counters cid-rWnnxwELsI" id="counters1-g">
    ...
    <div class="container">
        <h2 class="mbr-section-title pb-3 align-center mbr-fonts-style display-2">Text to Speech TEST Run</h2>
        <h3 class="mbr-section-subtitle mbr-fonts-style display-5">
            <b><font color="green">Text to Speech is ready</font></b>
        </h3>
                ...
                <div class="card p-3 align-center col-12 col-md-6 col-lg-3">
                    <div class="panel-item p-3">
                        ...
                        <div class="card-text">
                            ...
                            <h4 class="mbr-content-title mbr-bold mbr-fonts-style display-7">Text To Speech Test Run</h4>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-8 col-md-offset-2 text-xs-center">
                ...
                <form action="loadingspeech.php" method="post" id="x">
				<br>				
                <input type="text" class="form-control" id="speechtext" name="speechtext" required>
				<br>
              
				<button type="submit" id="confirm-purchase">Send to Abu Saif</button>
				</form>
